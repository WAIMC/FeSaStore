...
@section('action', 'Thêm Khách Hàng')
            ...
            <div class="card shadow">
                <div class="container-fluid">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('customer.store') }}" id="formInsert" method="POST">
                                @csrf
                                <div class="row">
                                        ...
                                        <div class="col-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" aria-describedby="name" placeholder="Tên danh mục" value="{{ old('name')}}" required>
                                                    @error('name')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control @error('email') is-invalid @enderror" name="email" id="email" value="{{ old('email') }}" placeholder="Email" required>
                                                    @error('email')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" value="{{ old('password') }}" id="password" placeholder="Mật Khẩu" required>
                                                    @error('password')
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control  @error('phone') is-invalid @enderror" name="phone" id="phone" value="{{ old('phone') }}" placeholder="Điện Thoại">
                                                @error('phone')
