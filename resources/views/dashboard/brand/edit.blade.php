                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="name" value="{{$brand->name}}" class="form-control"@error('name')   is-invalid
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" readonly name="image" value="{{$brand->logo}}" id="image" class="form-control">
                                @error('image')
                                <small  class="text-danger">{{$message}}</small> 
                                @enderror
                            </div>
