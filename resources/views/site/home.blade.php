...
@section('content')
                    ...
                    <div class="col-xl-9 col-lg-8 slider_box">
                        <div class="slider-wrapper theme-default">
                            ...
                            <div id="slider" class="nivoSlider">
                                <a href="shop.html"><img src="{{url('public')}}/frontend/img\slider\4.jpg" data-thumb="img/slider/1.jpg" alt="" title="#htmlcaption"></a>
                                <a href="shop.html"><img src="{{url('public')}}/frontend/img\slider\3.jpg" data-thumb="img/slider/2.jpg" alt="" title="#htmlcaption2"></a>
                            </div>
                            <!-- Slider Background  Image Start-->
                        </div>
                    </div>
        ...
        <div class="image-banner pb-50 off-white-bg">
            <div class="container">
                <div class="col-img">
                    <a href="#"><img src="{{url('public')}}/frontend/img\banner\h1-banner.jpg" alt="image banner"></a>
                </div>
            </div>
            <!-- Container End -->
        </div>
               ...
               <!-- Product Title End -->
                ...
                <div class="hot-deal-active owl-carousel">
                    ...
                    <div class="single-product">
                        ...
                        <div class="pro-img">
                            <a href="product.html">
                                ...
                                <img class="secondary-img" src="{{url('public')}}/frontend/img\products\7.jpg" alt="single-product">
                            </a>
                    ...
                    <div class="single-product">
                        ...
                        <div class="pro-img">
                            <a href="product.html">
                                <img class="primary-img" src="{{url('public')}}/frontend/img\products\24.jpg" alt="single-product">
                    ...
                    <div class="single-product">
                        ...
                        <div class="pro-img">
                            <a href="product.html">
                                <img class="primary-img" src="{{url('public')}}/frontend/img\products\10.jpg" alt="single-product">
                                <img class="secondary-img" src="{{url('public')}}/frontend/img\products\11.jpg" alt="single-product">
                            </a>
                            <div class="countdown" data-countdown="2020/03/01"></div>
                            <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                        </div>
        ...
        <div class="big-banner mt-100 pb-85 mt-sm-60 pb-sm-45">
            <div class="container banner-2">
                <div class="banner-box">
                    <div class="col-img">
                        <a href="#"><img src="{{url('public')}}/frontend/img\banner\banner3-1.jpg" alt="banner 3"></a>
                    </div>
                    <div class="col-img">
                        <a href="#"><img src="{{url('public')}}/frontend/img\banner\banner3-2.jpg" alt="banner 3"></a>
                    </div>
                </div>
                <div class="banner-box">
                    <div class="col-img">
                        <a href="#"><img src="{{url('public')}}/frontend/img\banner\banner3-3.jpg" alt="banner 3"></a>
                    </div>
                </div>
                <div class="banner-box">
                    <div class="col-img">
                        <a href="#"><img src="{{url('public')}}/frontend/img\banner\banner3-4.jpg" alt="banner 3"></a>
                    </div>
                    <div class="col-img">
                        <a href="#"><img src="{{url('public')}}/frontend/img\banner\banner3-5.jpg" alt="banner 3"></a>
                    </div>
                </div>
                <div class="banner-box">
                    <div class="col-img">
                        <a href="#"><img src="{{url('public')}}/frontend/img\banner\banner3-6.jpg" alt="banner 3"></a>
                    </div>
                </div>
                <div class="banner-box">
                    <div class="col-img">
                        <a href="#"><img src="{{url('public')}}/frontend/img\banner\banner3-7.jpg" alt="banner 3"></a>
                    </div>
                    <div class="col-img">
                        <a href="#"><img src="{{url('public')}}/frontend/img\banner\banner3-8.jpg" alt="banner 3"></a>
                    </div>
                </div>
            </div>
            <!-- Container End -->
                            ...
                            <div class="row">
                                <div class="col-lg-5 order-2 order-lg-1">
                                    <div class="banner-site-box mt-10">
                                        <div class="col-img">
                                            <a href="#"><img src="{{url('public')}}/frontend/img\banner\electorince.jpg" alt=""></a>
                                        </div>
                                        <!-- Single Product Start -->
                                        <div class="single-product mt-20">
                                            ...
                                            <div class="pro-img">
                                                <a href="product.html">
                                                    <img class="primary-img" src="{{url('public')}}/frontend/img\products\43.jpg" alt="single-product">
                                    ...
                                    <div class="electronics-pro-active2 owl-carousel">
                                        ...
                                        <div class="double-product">
                                            ...
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" src="{{url('public')}}/frontend/img\products\34.jpg" alt="single-product">
                                        ...
                                        <div class="double-product">
                                            ...
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" src="{{url('public')}}/frontend/img\products\32.jpg" alt="single-product">
                                                        <img class="secondary-img" src="{{url('public')}}/frontend/img\products\33.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                    ...
                                    <div class="electronics-pro-active2 owl-carousel">
                                            ...
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        ...
                                                        <img class="secondary-img" src="{{url('public')}}/frontend/img\products\39.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                        ...
                                        <div class="double-product">
                                            ...
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" src="{{url('public')}}/frontend/img\products\9.jpg" alt="single-product">
                                                        <img class="secondary-img" src="{{url('public')}}/frontend/img\products\10.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                    ...
                                    <div class="electronics-pro-active2 owl-carousel">
                                        ...
                                        <div class="double-product">
                                            ...
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" src="{{url('public')}}/frontend/img\products\19.jpg" alt="single-product">
                                                        <img class="secondary-img" src="{{url('public')}}/frontend/img\products\20.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                        ...
                                        <div class="double-product">
                                            ...
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        ...
                                                        <img class="secondary-img" src="{{url('public')}}/frontend/img\products\21.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                            ...
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" src="{{url('public')}}/frontend/img\products\21.jpg" alt="single-product">
                                                        <img class="secondary-img" src="{{url('public')}}/frontend/img\products\22.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                        ...
                                        <div class="double-product">
                                            ...
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" src="{{url('public')}}/frontend/img\products\26.jpg" alt="single-product">
                                                        <img class="secondary-img" src="{{url('public')}}/frontend/img\products\27.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                            ...
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" src="{{url('public')}}/frontend/img\products\28.jpg" alt="single-product">
                                                        <img class="secondary-img" src="{{url('public')}}/frontend/img\products\29.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                        ...
                        <div id="fshion-wmn" class="tab-pane fade show active">
                            <div class="row">
                                <div class="col-lg-5 order-2 order-lg-1">
                                    <div class="banner-site-box mt-10">
                                        <div class="col-img">
                                            <a href="#"><img src="{{url('public')}}/frontend/img\banner\banner-wmn.jpg" alt=""></a>
                                        </div>
                                        <!-- Single Product Start -->
                                        <div class="single-product mt-20">
                                            <!-- Product Image Start -->
                                            <div class="pro-img">
                                                <a href="product.html">
                                                    ...
                                                    <img class="secondary-img" src="{{url('public')}}/frontend/img\products\13.jpg" alt="single-product">
                                                </a>
                                                <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                            </div>
                                            <!-- Product Image End -->
                        ...
                        <div id="fshion-fnd" class="tab-pane fade show active">
                            <div class="row">
                                <div class="col-lg-5 order-2 order-lg-1">
                                    <div class="banner-site-box mt-10">
                                        <div class="col-img">
                                            <a href="#"><img src="{{url('public')}}/frontend/img\banner\banner-fnd.jpg" alt=""></a>
                                        </div>
                                        <!-- Single Product Start -->
                                        <div class="single-product mt-20">
                                            <!-- Product Image Start -->
                        ...
                        <div id="fshion-kds" class="tab-pane fade">
                            <div class="row">
                                <div class="col-lg-5 order-2 order-lg-1">
                                    <div class="banner-site-box mt-10">
                                        <div class="col-img">
                                            <a href="#"><img src="{{url('public')}}/frontend/img\banner\banner-kds.jpg" alt=""></a>
                                        </div>
                                        <!-- Single Product Start -->
                                        <div class="single-product mt-20">
                                            <!-- Product Image Start -->
        ...
        <div class="main-brand-banner pt-95 pb-100 pt-sm-55 pb-sm-60">
            <div class="container">
                ...
                <div class="row no-gutters">
                    <div class="col-lg-3">
                        <div class="col-img">
                            <img src="{{url('public')}}/frontend/img\banner\h1-band1.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <!-- Brand Banner Start -->
                        <div class="brand-banner owl-carousel">
                            <div class="single-brand">
                                <a href="#"><img class="img" src="{{url('public')}}/frontend/img\brand\1.jpg" alt="brand-image"></a>
                                <a href="#"><img src="{{url('public')}}/frontend/img\brand\2.jpg" alt="brand-image"></a>
                                <a href="#"><img src="{{url('public')}}/frontend/img\brand\3.jpg" alt="brand-image"></a>
                            </div>
                            <div class="single-brand">
                                <a href="#"><img class="img" src="{{url('public')}}/frontend/img\brand\1.jpg" alt="brand-image"></a>
                                <a href="#"><img src="{{url('public')}}/frontend/img\brand\2.jpg" alt="brand-image"></a>
                            ...
                            <div class="single-brand">
                                <a href="#"><img src="{{url('public')}}/frontend/img\brand\1.jpg" alt="brand-image"></a>
                                <a href="#"><img src="{{url('public')}}/frontend/img\brand\2.jpg" alt="brand-image"></a>
                                <a href="#"><img src="{{url('public')}}/frontend/img\brand\3.jpg" alt="brand-image"></a>
                            ...
                            <div class="single-brand">
                                <a href="#"><img src="{{url('public')}}/frontend/img\brand\2.jpg" alt="brand-image"></a>
                                <a href="#"><img src="{{url('public')}}/frontend/img\brand\3.jpg" alt="brand-image"></a>
                                <a href="#"><img src="{{url('public')}}/frontend/img\brand\4.jpg" alt="brand-image"></a>
                            </div>
                            <div class="single-brand">
                                <a href="#"><img src="{{url('public')}}/frontend/img\brand\2.jpg" alt="brand-image"></a>
                                <a href="#"><img src="{{url('public')}}/frontend/img\brand\3.jpg" alt="brand-image"></a>
                    ...
                    <div class="col-lg-3">
                        <div class="col-img">
                            <img src="{{url('public')}}/frontend/img\banner\h1-band2.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="big-banner pb-100 pb-sm-60">
            <div class="container big-banner-box">
                <div class="col-img">
                    <a href="#">
                    <img src="{{url('public')}}/frontend/img\banner\5.jpg" alt="">
                    </a>
                </div>
                <div class="col-img">
                    <a href="#">
                    <img src="{{url('public')}}/frontend/img\banner\h1-banner3.jpg" alt="">
                    </a>
                </div>
            </div>
            <!-- Container End -->
