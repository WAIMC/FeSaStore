            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="register-title">
                        ...
                        <p class="mb-10">Nếu bạn đã có tài khoản với chúng tôi, vui lòng đăng nhập tại trang đăng
                            nhập.</p>
                    </div>
                </div>
            </div>
                    ...
                    <form class="form-register" id="formid" action="" method="POST">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group d-md-flex align-items-md-center">
                                <label class="control-label col-md-2" for="f-name"><span class="require">*</span>Họ
                                    và tên</label>
                                <div class="col-md-10">
                                    <input type="text" name="name" value="{{ old('name') }}" class="form-control"
                                        id="f-name" placeholder="Họ và tên">
                                    @error('name')
                            ...
                            <div class="form-group d-md-flex align-items-md-center">
                                ...
                                <div class="col-md-10">
                                    <input type="email" value="{{ old('email') }}" name="email" class="form-control"
                                        id="email" placeholder="Nhập địa chỉ email của bạn vào đây ...">
                                    @error('email')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                            ...
                            <div class="form-group d-md-flex align-items-md-center">
                                <label class="control-label col-md-2" for="number"><span class="require">*</span>
                                    Điện thoại</label>
                                <div class="col-md-10">
                                    <input type="text" name="phone" value="{{ old('phone') }}" class="form-control"
                                        id="number" placeholder=" Điện thoại">
                                    @error('phone')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                        ...
                        <fieldset>
                            ...
                            <div class="form-group d-md-flex align-items-md-center">
                                ...
                                <div class="col-md-10">
                                    <input type="password" name="pwd_confirm" class="form-control" id="pwd-confirm"
                        ...
                        <div class="terms">
                            <div class="float-md-right">
                                <span>Tôi đã đọc và đồng ý với <a href="#" class="agree"><b>Chính sách quyền riêng
                                            tư</b></a></span>
