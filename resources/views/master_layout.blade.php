...
<head>
    ...
    <!-- Favicons -->
    <link rel="shortcut icon" href="{{url('public')}}/frontend/img\favicon.ico">
    <!-- Fontawesome css -->
    ...
    <!-- Jquery fancybox css -->
    <link rel="stylesheet" href="{{url('public')}}/frontend/css\jquery.fancybox.css">
...
<body>
       ...
       <!-- Banner Popup Start -->
        <div class="popup_banner">
            ...
            <div class="banner_popup_area">
                    <img src="{{url('public')}}/frontend/img\banner\pop-banner.jpg" alt="">
            </div>
        </div>
        <!-- Banner Popup End -->
            ...
            <div class="header-top-area">
                <div class="container">
                    ...
                    <div class="header-top">
                        <ul>
                            <li><a href="#">Miễn phí ship từ đơn hàng thứ 3</a></li>
                        ...
                        <ul>                                          
                            <li><span>Ngôn ngữ</span> <a href="#"><i class="lnr lnr-chevron-down"></i></a>
                                ...
                                <ul class="ht-dropdown">
                                    <li><a href="#"><img src="{{url('public')}}/frontend/img\header\1.jpg" alt="language-selector">English</a></li>
                                    <li><a href="#"><img src="{{url('public')}}/frontend/img\header\2.jpg" alt="language-selector">Tiếng Việt</a></li>
                                </ul>
                                <!-- Dropdown End -->
                            </li>
                            <li><span>Đơn vị</span><a href="#"> <i class="lnr lnr-chevron-down"></i></a>
                                <!-- Dropdown Start -->
                                <ul class="ht-dropdown">
                                    <li><a href="#">&#36; USD</a></li>
                                    <li><a href="#"> € Euro</a></li>
                    ...
                    <div class="row align-items-center no-gutters">
                        <div class="col-lg-3 col-md-12">
                            <div class="logo mb-all-30">
                                <a href="index.html"><img src="{{url('public')}}/frontend/img\logo\logo.png" alt="logo-image"></a>
                            </div>
                        </div>
                                        ...
                                        <ul class="ht-dropdown cart-box-width">
                                            <li>
                                                ...
                                                <div class="single-cart-box">
                                                    <div class="cart-img">
                                                        <a href="#"><img src="{{url('public')}}/frontend/img\products\1.jpg" alt="cart-image"></a>
                                                ...
                                                <div class="single-cart-box">
                                                    <div class="cart-img">
                                                        <a href="#"><img src="{{url('public')}}/frontend/img\products\2.jpg" alt="cart-image"></a>
                                                        <span class="pro-quantity">1X</span>
                                                    </div>
                                                    <div class="cart-content">
                            ...
                            <div class="single-footer mb-sm-40">
                                ...
                                <div class="footer-content">
                                    ...
                                    <div class="payment mt-25 bdr-top pt-30">
                                        <a href="#"><img class="img" src="{{url('public')}}/frontend/img\payment\1.png" alt="payment-image"></a>
                                    </div>                                   
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="footer-middle-content pt-20 pb-30">
                            <ul class="social-footer">
                                ...
                                <li><a href="#"><img src="{{url('public')}}/frontend/img\icon\social-img1.png" alt="google play"></a></li>
                                <li><a href="#"><img src="{{url('public')}}/frontend/img\icon\social-img2.png" alt="app store"></a></li>
                            </ul>
                    </div>
                </div>
                <!-- Container End -->
                                    ...
                                    <div class="col-lg-5 col-md-6 col-sm-5">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div id="thumb2" class="tab-pane fade">
                                                <a data-fancybox="images" href="{{url('public')}}/frontend/img\products\13.jpg"><img src="{{url('public')}}/frontend/img\products\13.jpg" alt="product-view"></a>
                                            </div>
                                            <div id="thumb3" class="tab-pane fade">
                                                <a data-fancybox="images" href="{{url('public')}}/frontend/img\products\15.jpg"><img src="{{url('public')}}/frontend/img\products\15.jpg" alt="product-view"></a>
                                            </div>
                                            <div id="thumb4" class="tab-pane fade">
                                                <a data-fancybox="images" href="{{url('public')}}/frontend/img\products\4.jpg"><img src="{{url('public')}}/frontend/img\products\4.jpg" alt="product-view"></a>
                                            </div>
                                            <div id="thumb5" class="tab-pane fade">
                                                <a data-fancybox="images" href="{{url('public')}}/frontend/img\products\5.jpg"><img src="{{url('public')}}/frontend/img\products\5.jpg" alt="product-view"></a>
                                            </div>
                                        </div>
    ...
    <!-- ScrollUp js -->
    <script src="{{url('public')}}/frontend/js\jquery.scrollUp.js"></script>
    <!-- Nivo slider js -->
    <script src="{{url('public')}}/frontend/js\jquery.nivo.slider.js"></script>
    <!-- Fancybox js -->
    <script src="{{url('public')}}/frontend/js\jquery.fancybox.min.js"></script>
